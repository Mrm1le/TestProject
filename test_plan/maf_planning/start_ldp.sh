...
echo "LDP_PLANNING_RESOURCE_PATH: " ${LDP_PLANNING_RESOURCE_PATH}
echo "MFR_RELEASE_PATH: " ${MFR_RELEASE_PATH}
echo "MSD_LIB_MIMALLOC_PATH" ${MSD_LIB_MIMALLOC_PATH}

export LDP_PLANNING_MFR_LIBRARY=${CMAKE_BINARY_PATH}/lib/libldp_mfr_node.so
mfrlaunch_yaml_file=$PACKAGE_PATH/launch/ldp_mfr_node.yaml
