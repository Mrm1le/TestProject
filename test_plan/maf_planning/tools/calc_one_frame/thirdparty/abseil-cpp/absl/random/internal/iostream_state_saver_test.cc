...
TEST(IOStreamStateSaver, RoundTripFloats) {
  ...
  const float kValues[] = {
      1, std::nextafter(1.0f, 0.0f),  // 1 - epsilon
      std::nextafter(1.0f, 2.0f),     // 1 + epsilon

      1.0e+1f, 1.0e-1f, 1.0e+2f, 1.0e-2f, 1.0e+10f, 1.0e-10f,

      0.00000051110000111311111111f, -0.00000051110000111211111111f,

      1.234678912345678912345e+6f, 1.234678912345678912345e-6f,
      1.234678912345678912345e+30f, 1.234678912345678912345e-30f,
      1.234678912345678912345e+38f, 1.0234678912345678912345e-38f,
...
TEST(IOStreamStateSaver, RoundTripDoubles) {
  ...
  const double kValues[] = {
      1, std::nextafter(1.0, 0.0),  // 1 - epsilon
      std::nextafter(1.0, 2.0),     // 1 + epsilon

      1.0e+1, 1.0e-1, 1.0e+2, 1.0e-2, 1.0e+10, 1.0e-10,

      0.00000051110000111311111111, -0.00000051110000111211111111,

      1.234678912345678912345e+6, 1.234678912345678912345e-6,
      1.234678912345678912345e+30, 1.234678912345678912345e-30,
      1.234678912345678912345e+38, 1.0234678912345678912345e-38,

      1.0e+100, 1.0e-100, 1.234678912345678912345e+308,
      1.0234678912345678912345e-308, 2.22507385850720138e-308,
