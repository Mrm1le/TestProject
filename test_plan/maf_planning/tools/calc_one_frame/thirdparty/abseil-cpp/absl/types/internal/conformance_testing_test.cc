...
struct BadMoveConstruct {
  ...
  BadMoveConstruct(BadMoveConstruct&& other) noexcept : value(other.value + 1) {
  }
...
struct BadDefaultInitializedMoveAssign {
  ...
  BadDefaultInitializedMoveAssign(
      BadDefaultInitializedMoveAssign&& other) noexcept : value(other.value) {}
...
struct BadDefaultInitializedCopyAssign {
  ...
  BadDefaultInitializedCopyAssign(
      BadDefaultInitializedCopyAssign&& other) noexcept : value(other.value) {}
