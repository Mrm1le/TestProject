...
// We use the intrinsic when available to improve performance.
 ...
 private:
  ...
  static MixingHashState RunCombineUnordered(MixingHashState state,
    ...
    combiner(MixingHashState{},
             [&](MixingHashState& inner_state) {
               // Add the hash state of the element to the running total, but
               // mix the
               // carry bit back into the low bit.  This in intended to avoid
               // losing
               // entropy to overflow, especially when unordered_multisets
               // contain
