...
#include "common/refline/refline_smoother/affine_constraint.h"
...
public:
   ...
   **/
  bool
  Add2dBoundary(const std::vector<double> &t_coord,
                const std::vector<double> &angle,
                const std::vector<msquare::planning_math::Vec2d> &ref_point,
  ...
  bool AddSecondDerivativeSmoothConstraint(
      const std::vector<planning_math::Vec2d> &ref_point); // zyl
...
private:
  ...
  double SignDistance(const msquare::planning_math::Vec2d &xy_point,
