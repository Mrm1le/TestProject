#ifndef MODULES_PLANNING_MATH_POLYGON2D_H_
#define MODULES_PLANNING_MATH_POLYGON2D_H_
...
public:
  ...
  void update(const Box2d &box);

  void update(const std::vector<Vec2d> &points);

  void set_points(const std::vector<Vec2d> &points) {
    points_ = points;
...
#endif /* MODULES_PLANNING_MATH_POLYGON2D_H_ */
