...
public:
  ...
  NLOHMANN_DEFINE_TYPE_INTRUSIVE(LineSegment2d, start_, end_, unit_direction_,
                                 heading_, length_, min_x_, max_x_, min_y_,
                                 max_y_)
private:
  void initMaxMin();
  Vec2d start_;
  ...
  mutable bool heading_generated_ = false;
...
#endif /* MODULES_PLANNING_MATH_LINE_SEGMENT2D_H_ */