...
public:
    static double getSpeed(const planning_math::Box2d& slot_box, const Pose2D & ego_pose, const std::vector<float> &traj_curvature, const SvSpeedParam &sv_speed_param, bool & is_in_slot);
    static double regulateSpeed(const planning_math::Box2d& slot_box, const Pose2D & ego_pose, const std::vector<float> &traj_curvature, const SvSpeedParam &sv_p, bool & is_in_slot);
};
