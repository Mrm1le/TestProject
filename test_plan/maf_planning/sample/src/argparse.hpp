...
public:
  ...
  explicit EntryItem(const std::vector<bool> &);
...
public:
  ArgValue() = default;
  explicit ArgValue(std::map<std::string, ParamEntry> value)
...
public:
  explicit StringArrayValue(const std::vector<std::string> &value)
      : value_(value.begin(), value.end()) {}
...
public:
  explicit IntArrayValue(const std::vector<int> &value)
      : value_(value.begin(), value.end()) {}
...
public:
  explicit DoubleArrayValue(const std::vector<double> &value)
      : value_(value.begin(), value.end()) {}
...
public:
  explicit BoolArrayValue(const std::vector<bool> &value)
      : value_(value.begin(), value.end()) {}
