#ifndef MSQUARE_DECISION_PLANNING_COMMON_PARKING_VISION_INFO_H
#define MSQUARE_DECISION_PLANNING_COMMON_PARKING_VISION_INFO_H
...
enum class GroundLineType {
  ...
  GROUND_LINE_TYPE_USS_REALTIME_OBSTACLE = 8,
  ...
  GROUND_LINE_USS_TYPE_VEHICLE= 106,
  GROUND_LINE_USS_TYPE_ONLY_USS_UNKNOWN = 107,
  // point, for parking slot opposite obs
  GROUND_LINE_USS_TYPE_POINT = 200,
  // point, for parking general obs
  GROUND_LINE_USS_TYPE_POINT_GENERAL_WALL = 201,
  GROUND_LINE_USS_TYPE_POINT_GENERAL_PILLAR = 202,
  GROUND_LINE_USS_TYPE_POINT_GENERAL_FENCE = 203,
  GROUND_LINE_USS_TYPE_POINT_GENERAL_STEP = 204,
  GROUND_LINE_USS_TYPE_POINT_GENERAL_SPECIAL = 205,
  GROUND_LINE_USS_TYPE_POINT_GENERAL_VEHICLE = 206,
  GROUND_LINE_USS_TYPE_POINT_GENERAL_ONLY_USS_UNKNOWN = 207,
